...
INSERT INTO ADRESLER VALUES('MEVLANA','15 TEMMUZ','TBMYO','KAYSERI',3800,'TURKIYE')
INSERT INTO ADRESLER VALUES('BEYAZ','SONMEZ','34','KAYSERI',38000,'TURKIYE')

UPDATE ADRESLER SET POSTA_KODU=1600 WHERE ADRES_NO=2;

INSERT INTO UYELER VALUES('SEMIH','GUNEY','E',05434124741,'semihguney@gmail.com',1)
INSERT INTO UYELER VALUES('MEHMET','SOYDEMIR','E',05554441122,'mehmetsoydemir@gmail.com',2)

UPDATE UYELER SET TELEFON=05455552211 WHERE UYE_NO=1;

DELETE FROM UYELER WHERE UYE_NO=3;

INSERT INTO UYELER VALUES('ARIF','SAYGIN','E',05221112585,'arifsaygin@gmail.com',2);
